...
void TestRenderComponent::awake()
{
	createSwapChain();
	createImageViews();
	createRenderPass();
...
void TestRenderComponent::update()
{
	rect_mesh_->update();
}

void TestRenderComponent::destroy()
{
...
//동적으로 바인딩될 녀석들 
void TestRenderComponent::createDescriptorSetLayout()
{
...
void TestRenderComponent::createUniformBuffer()
{
...
void TestRenderComponent::createDescriptorPool()
{
...
void TestRenderComponent::createDescriptorSet()
{
...
void TestRenderComponent::updateUniformBuffer()
{
...
void TestRenderComponent::createTextureImage()
{
...
void TestRenderComponent::createTextureImageView()
{
	textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_ASPECT_COLOR_BIT);

}

void TestRenderComponent::createTextureSampler()
{
...
void TestRenderComponent::drawFrame()
{
	updateUniformBuffer();
...
void TestRenderComponent::createSwapChain()
{
...
void TestRenderComponent::createImageViews()
{
...
VkSurfaceFormatKHR TestRenderComponent::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
{
...
VkPresentModeKHR TestRenderComponent::chooseSwapPresentMode(const std::vector<VkPresentModeKHR> availablePresentModes)
{
...
VkExtent2D TestRenderComponent::chooseSwapExtent(const VkSurfaceCapabilitiesKHR & capabilities)
{
...
void TestRenderComponent::createRenderPass()
{
	//render target 초기화 
...
void TestRenderComponent::createGraphicsPipeline()
{
	//shader info
...
VkShaderModule TestRenderComponent::createShaderModule(const std::vector<char>& code)
{
...
void TestRenderComponent::createFramebuffers()
{
...
void TestRenderComponent::createCommandPool()
{
...
void TestRenderComponent::createCommandBuffers()
{
...
void TestRenderComponent::createSemaphores()
{
...
void TestRenderComponent::cleanupSwapChain()
{
...
void TestRenderComponent::recreateSwapChain()
{
...
void TestRenderComponent::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage & image, VkDeviceMemory & imageMemory)
{
...
VkCommandBuffer TestRenderComponent::beginSingleTimeCommands()
{
	VkCommandBufferAllocateInfo allocInfo = {};
	allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
	allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
...
void TestRenderComponent::endSingleTimeCommands(VkCommandBuffer commandBuffer)
{
...
void TestRenderComponent::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size)
{
...
void TestRenderComponent::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout)
{
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void TestRenderComponent::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height)
{
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
VkImageView TestRenderComponent::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags)
{
...
void TestRenderComponent::createDepthResources()
{
...
VkFormat TestRenderComponent::findDepthFormat()
{
...
bool TestRenderComponent::hasStencilComponent(VkFormat format)
{
	return format == VK_FORMAT_D32_SFLOAT_S8_UINT || format == VK_FORMAT_D24_UNORM_S8_UINT;
}


TestRenderComponent::TestRenderComponent() : GAD::GADComponent<TestRenderComponent>("test_render_component")
{
