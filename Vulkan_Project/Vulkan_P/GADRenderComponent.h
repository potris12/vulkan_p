...
namespace GADEngine {
	...
	class GADRenderComponent : public nomad::Component<GADRenderComponent>
	{
	public:
		void awake();
		void start() {};
		...
		static void onWindowResized(GLFWwindow* window, int width, int height) {
			...
			GADRenderComponent* app = reinterpret_cast<GADRenderComponent*>(glfwGetWindowUserPointer(window));
