...
void GADRenderComponent::update()
{
	rect_mesh_->update();
}

void GADRenderComponent::destroy()
{
...
//동적으로 바인딩될 녀석들 
void GADRenderComponent::createDescriptorSetLayout()
{
...
void GADRenderComponent::createUniformBuffer()
{
...
void GADRenderComponent::createDescriptorPool()
{
...
void GADRenderComponent::createDescriptorSet()
{
...
void GADRenderComponent::updateUniformBuffer()
{
...
void GADRenderComponent::createTextureImage()
{
...
void GADRenderComponent::createTextureImageView()
{
	textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_ASPECT_COLOR_BIT);

}

void GADRenderComponent::createTextureSampler()
{
...
void GADRenderComponent::drawFrame()
{
	updateUniformBuffer();
...
void GADRenderComponent::createSwapChain()
{
...
void GADRenderComponent::createImageViews()
{
...
VkSurfaceFormatKHR GADRenderComponent::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
{
...
VkPresentModeKHR GADRenderComponent::chooseSwapPresentMode(const std::vector<VkPresentModeKHR> availablePresentModes)
{
...
VkExtent2D GADRenderComponent::chooseSwapExtent(const VkSurfaceCapabilitiesKHR & capabilities)
{
...
void GADRenderComponent::createRenderPass()
{
	//render target 초기화 
...
void GADRenderComponent::createGraphicsPipeline()
{
	//shader info
...
VkShaderModule GADRenderComponent::createShaderModule(const std::vector<char>& code)
{
...
void GADRenderComponent::createFramebuffers()
{
...
void GADRenderComponent::createCommandPool()
{
...
void GADRenderComponent::createCommandBuffers()
{
	...
	rect_mesh_->createVertexBuffer(commandPool);
	rect_mesh_->awake();
...
void GADRenderComponent::createSemaphores()
{
...
void GADRenderComponent::cleanupSwapChain()
{
...
void GADRenderComponent::recreateSwapChain()
{
...
void GADRenderComponent::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage & image, VkDeviceMemory & imageMemory)
{
...
VkCommandBuffer GADRenderComponent::beginSingleTimeCommands()
{
	VkCommandBufferAllocateInfo allocInfo = {};
	allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
	allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
...
void GADRenderComponent::endSingleTimeCommands(VkCommandBuffer commandBuffer)
{
...
void GADRenderComponent::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size)
{
...
void GADRenderComponent::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout)
{
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void GADRenderComponent::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height)
{
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
VkImageView GADRenderComponent::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags)
{
...
void GADRenderComponent::createDepthResources()
{
...
VkFormat GADRenderComponent::findDepthFormat()
{
...
bool GADRenderComponent::hasStencilComponent(VkFormat format)
{
	return format == VK_FORMAT_D32_SFLOAT_S8_UINT || format == VK_FORMAT_D24_UNORM_S8_UINT;
}

GADEngine::GADRenderComponent::GADRenderComponent()
{
	//awake();
}

GADRenderComponent::~GADRenderComponent()
{
	destroy();
}
